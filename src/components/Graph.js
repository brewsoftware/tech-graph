...
const redata  = {
  nodes: [
    {id: 'Jason Turner', color: 'black', gravity: 0.1},
      {id: 'Techniques', color: 'red'},
        {id: 'Management', color: 'red'},
          {id: 'Waterfall', color: 'red'},
          {id: 'Agile' , color:'red'},
        {id: 'Architecure', color: 'red'},
          {id: 'CQRS', color: 'red'},
          {id: 'CAP Theorem', color: 'red'},
          {id: 'Eventual Consistency', color: 'red'},
          {id: 'OWASP', color: 'red'},
          {id: 'Object Oriented', color: 'red'},
          {id: 'Functional', color: 'red'},
